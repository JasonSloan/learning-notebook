...
static int convert_image_rga(image_buffer_t* src_img, image_buffer_t* dst_img, image_rect_t* src_box, image_rect_t* dst_box, char color)
{
    ...
    void *src_phy = NULL;
    int srcFmt = get_rga_fmt(src_img->format);      // IMAGE_FORMAT_RGB888 ----> RK_FORMAT_RGB_888
    ...
    void *dst_phy = NULL;
    int dstFmt = get_rga_fmt(dst_img->format);      // IMAGE_FORMAT_RGB888 ----> RK_FORMAT_RGB_888
